...
<div id="modal" class="default_modal">
        ...
        <div class="right_side">
            <div class="pizza_type-item">
                <label>
                    ...
                    <select class="pizza_type-input" name="TypesList" id="TypesList">
            ...
            <div class="pizza_size-item">
                <label>
                    ...
                    <select class="pizza_size-input" name="SizesList" id="SizesList">
            ...
            <div class="pizza_count-item">
                <label>
                    ...
                    <input class="pizza_count-input" type="text">
                </label>
            </div>
        </div>
    </div>
